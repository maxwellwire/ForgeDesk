  ...
  return (
    <div style={{ background: "#0D0D0D", minHeight: "100vh", fontFamily: "Inter, sans-serif" }}>
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "56px 20px 0" }}>
        ...
        >
          Post the task. Collect the proof.{" "}
          <span style={{ color: "#C8FF4D" }}>Review every one.</span>
        </h1>
        <p
          style={{
            color: "#9A9A93",
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "64px 20px 0" }}>
        ...
        >
          {[
            ...
            {
              n: "04",
              t: "Get reviewed and paid",
              d: "A real admin checks your submission and rewards get tracked.",
            },
          ].map((s) => (
            <div
              key={s.n}
            ...
            >
              ...
              <p style={{ color: "#F5F5F0", fontSize: 14.5, fontWeight: 600, margin: "0 0 6px" }}>
                {s.t}
              </p>
              <p style={{ color: "#9A9A93", fontSize: 13, margin: 0, lineHeight: 1.5 }}>
                {s.d}
              </p>
            </div>
          ))}
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "64px 20px 0" }}>
        ...
        >
          {[
            ...
            { n: "03", t: "Campaign goes live", d: "Participants join and complete real tasks." },
            {
              ...
              d: "We review, select winners, and track rewards.",
            },
          ].map((s) => (
            <div
              key={s.n}
        ...
        <a
          href="/request-campaign"
          style={{ ...secondaryButton, display: "inline-block", marginTop: 28 }}
        >
          Request a campaign
        </a>
      </section>
