...
async function GET(req, { params }) {
    ...
    const campaign = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].campaign.findUnique({
        where: {
            id
        },
        include: {
    ...
    if (user) {
        const participation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].participation.findUnique({
            where: {
                campaignId_userId: {
                    campaignId: id,
                    userId: user.id
...
async function createSession(userId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.create({
        data: {
            userId,
...
async function destroySession() {
    ...
    const token = cookieStore.get(SESSION_COOKIE_NAME)?.value;
    if (token) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.deleteMany({
            where: {
                tokenHash: hashToken(token)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04n3dsh._.js.map